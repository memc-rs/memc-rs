...
mod tests {
    ...
    fn create_response_header(cmd: binary::Command, opaque: u32, cas: u64) -> binary::ResponseHeader {
        ...
        binary::ResponseHeader::new(cmd as u8, opaque);
    ...
    fn encode_replace_response() {
        ...
        let response = BinaryResponse::Replace(binary::ReplaceResponse {
            header,
        });               
        let expected_result: [u8; 24] = [
            0x81, 0x03, 0x00, 0x00,
    ...
    fn encode_add_response() {
        ...
        let response = BinaryResponse::Add(binary::AddResponse {
            header,
        });               
        let expected_result: [u8; 24] = [
            0x81, 0x02, 0x00, 0x00,
    ...
    fn encode_append_response() {
        ...
        let response = BinaryResponse::Append(binary::AppendResponse {
            header,
        });               
        let expected_result: [u8; 24] = [
            0x81, 0x0e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02
        ];        
        test_encode(&expected_result, response);
    }
    ...
    fn encode_prepend_response() {
        ...
        let response = BinaryResponse::Prepend(binary::PrependResponse {
            header,
        });               
        let expected_result: [u8; 24] = [
            0x81, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03
        ];        
        test_encode(&expected_result, response);
    }
    ...
    fn encode_noop_response() {
        ...
        let response = BinaryResponse::Noop(binary::NoopResponse {
            header,
        });                               
        test_encode(&expected_result, response);
    }
    ...
    fn encode_delete_response() {
        ...
        let expected_result: [u8; 24] = [
            ...
            0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
        let response = BinaryResponse::Delete(binary::DeleteResponse {
            header,
        });                               
        test_encode(&expected_result, response);
    }
    ...
    fn encode_flush_response() {        
        ...
        let response = BinaryResponse::Flush(binary::FlushResponse {
            header,
        });                               
        test_encode(&expected_result, response);
    }
    ...
    fn encode_increment_response() {
        let expected_result: [u8; 32] = [
            ...
            0x00, 0x00, 0x00, 0x08, 
            0x00, 0x00, 0x00, 0x00, 
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, // cas: 5
    ...
    fn encode_decrement_response() {
        let expected_result: [u8; 32] = [
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0b, 0xea
        ];
    ...
    fn encode_version_response() {
        let expected_result: [u8; 29] = [
            0x81, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x31, 0x2e, 0x36, 0x2e, 0x32
        ];
